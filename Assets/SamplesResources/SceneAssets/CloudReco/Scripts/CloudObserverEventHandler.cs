...
public class CloudObserverEventHandler : DefaultObserverEventHandler
{
    ...
    protected override void OnTrackingLost()
    {
        ...
        if (mCloudContentManager)
		  ...
		  StartCoroutine(HideTargetInfo());	//Modificado para que se oculte la informacion luego de 7 segundos cuando se pierde el foco
    }
	
	//AGREGADO///////////////////////////////	
	/// <summary>
    /// La informacion se oculta luego de 7 segundos 
    /// </summary>
